...
За собранный кубик игрок получит бонусные очки[*](#ask). 
...
* Изучить самую простую методику сборки кубика-рубика.
* Научиться реализовать паттерны вращения.
* Анализировать состояние поля с тем, чтобы понять какой из паттернов применить сейчас.
* Этап за этапом приближаться к решенному кубику.
